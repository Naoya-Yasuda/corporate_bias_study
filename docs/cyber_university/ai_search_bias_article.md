...
ランキング（推薦順位）と感情評価（NBI）の関係は、業界によって異なる傾向が見られました。

**世界的テック企業5社：一致傾向**
- **Microsoft**: NBI最高（約1.3）で、ランキングも上位
- **Meta**: NBI中程度（約1.0）で、ランキングは最下位

NBIが高い企業ほどランキングでも上位に推薦される傾向があり、感情評価と推薦順位がある程度一致していました。

**日本の大学：乖離傾向**（2025年12月15日時点）

![日本の大学における感情評価とランキングの相関グラフ](https://storage.googleapis.com/zenn-user-upload/79a98fd92f7d-20260103.png)
*ランキング順位と感情評価（NBI）の乖離*

一方、日本の大学では異なるパターンが見られました。サイバー大学はランキングでは最下位ですが、感情評価（NBI）では東京大学を上回っています。知名度や偏差値で測られる「おすすめ順」と、AIが文脈から読み取る「評価」が乖離するケースもあるようです。
